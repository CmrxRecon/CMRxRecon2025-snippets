          ...
          if status == "SCORED":
              ...
              if len(annots) == 0:
                  ...
                  message = ["Hello %s,\n\n" % name,
                             ...
                             "The detail log for each data can be found in: https://www.synapse.org/#!Synapse:syn59064827, "
                             "store separately in Task1-detail_logs and Task2-detail_logs, named by %s.zip\n\n" % sub.id,
