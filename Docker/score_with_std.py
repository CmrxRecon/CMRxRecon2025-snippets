...
def CalValue(complete_folders, gt_dir, target_dir, Sub_Task):
    ...
    return psnr_results, ssim_results, nmse_results,psnr_results_std,ssim_results_std,nmse_results_std
'''
========================================= 需要上传 以下内容 ==============================================
'''
def get_args():
...
def main():
    ...
    if args.task == 'Cine':
        ...
        psnr_results_lax_04_Single, ssim_results_lax_04_Single, nmse_results_lax_04_Single,\
            psnr_results_lax_04_Single_std, ssim_results_lax_04_Single_std, nmse_results_lax_04_Single_std = CalValue(
        ...
        psnr_results_lax_08_Single, ssim_results_lax_08_Single, nmse_results_lax_08_Single,\
            psnr_results_lax_08_Single_std, ssim_results_lax_08_Single_std, nmse_results_lax_08_Single_std= CalValue(
        ...
        psnr_results_lax_10_Single, ssim_results_lax_10_Single, nmse_results_lax_10_Single,\
            psnr_results_lax_10_Single_std, ssim_results_lax_10_Single_std, nmse_results_lax_10_Single_std= CalValue(
        ...
        psnr_results_lax_04_Multi, ssim_results_lax_04_Multi, nmse_results_lax_04_Multi,\
            psnr_results_lax_04_Multi_std, ssim_results_lax_04_Multi_std, nmse_results_lax_04_Multi_std= CalValue(
        ...
        psnr_results_lax_08_Multi, ssim_results_lax_08_Multi, nmse_results_lax_08_Multi,\
            psnr_results_lax_08_Multi_std, ssim_results_lax_08_Multi_std, nmse_results_lax_08_Multi_std= CalValue(
        ...
        psnr_results_lax_10_Multi, ssim_results_lax_10_Multi, nmse_results_lax_10_Multi,\
            psnr_results_lax_10_Multi_std, ssim_results_lax_10_Multi_std, nmse_results_lax_10_Multi_std = CalValue(
        ...
        psnr_results_sax_04_Single, ssim_results_sax_04_Single, nmse_results_sax_04_Single,\
            psnr_results_sax_04_Single_std, ssim_results_sax_04_Single_std, nmse_results_sax_04_Single_std= CalValue(
        ...
        psnr_results_sax_08_Single, ssim_results_sax_08_Single, nmse_results_sax_08_Single,\
            psnr_results_sax_08_Single_std, ssim_results_sax_08_Single_std, nmse_results_sax_08_Single_std= CalValue(
        ...
        psnr_results_sax_10_Single, ssim_results_sax_10_Single, nmse_results_sax_10_Single,\
            psnr_results_sax_10_Single_std, ssim_results_sax_10_Single_std, nmse_results_sax_10_Single_std= CalValue(
        ...
        psnr_results_sax_04_Multi, ssim_results_sax_04_Multi, nmse_results_sax_04_Multi,\
            psnr_results_sax_04_Multi_std, ssim_results_sax_04_Multi_std, nmse_results_sax_04_Multi_std= CalValue(
        ...
        psnr_results_sax_08_Multi, ssim_results_sax_08_Multi, nmse_results_sax_08_Multi,\
            psnr_results_sax_08_Multi_std, ssim_results_sax_08_Multi_std, nmse_results_sax_08_Multi_std= CalValue(
        ...
        psnr_results_sax_10_Multi, ssim_results_sax_10_Multi, nmse_results_sax_10_Multi,\
            psnr_results_sax_10_Multi_std, ssim_results_sax_10_Multi_std, nmse_results_sax_10_Multi_std= CalValue(
        ...
        psnr_results_T1_04_Single, ssim_results_T1_04_Single, nmse_results_T1_04_Single,\
            psnr_results_T1_04_Single_std, ssim_results_T1_04_Single_std, nmse_results_T1_04_Single_std= CalValue(
        ...
        psnr_results_T1_08_Single, ssim_results_T1_08_Single, nmse_results_T1_08_Single,\
            psnr_results_T1_08_Single_std, ssim_results_T1_08_Single_std, nmse_results_T1_08_Single_std= CalValue(
        ...
        psnr_results_T1_10_Single, ssim_results_T1_10_Single, nmse_results_T1_10_Single,\
            psnr_results_T1_10_Single_std, ssim_results_T1_10_Single_std, nmse_results_T1_10_Single_std= CalValue(
        ...
        psnr_results_T1_04_Multi, ssim_results_T1_04_Multi, nmse_results_T1_04_Multi,\
            psnr_results_T1_04_Multi_std, ssim_results_T1_04_Multi_std, nmse_results_T1_04_Multi_std= CalValue(
        ...
        psnr_results_T1_08_Multi, ssim_results_T1_08_Multi, nmse_results_T1_08_Multi,\
            psnr_results_T1_08_Multi_std, ssim_results_T1_08_Multi_std, nmse_results_T1_08_Multi_std= CalValue(
        ...
        psnr_results_T1_10_Multi, ssim_results_T1_10_Multi, nmse_results_T1_10_Multi,\
            psnr_results_T1_10_Multi_std, ssim_results_T1_10_Multi_std, nmse_results_T1_10_Multi_std= CalValue(
        ...
        psnr_results_T2_04_Single, ssim_results_T2_04_Single, nmse_results_T2_04_Single,\
            psnr_results_T2_04_Single_std, ssim_results_T2_04_Single_std, nmse_results_T2_04_Single_std= CalValue(
        ...
        psnr_results_T2_08_Single, ssim_results_T2_08_Single, nmse_results_T2_08_Single,\
            psnr_results_T2_08_Single_std, ssim_results_T2_08_Single_std, nmse_results_T2_08_Single_std= CalValue(
        ...
        psnr_results_T2_10_Single, ssim_results_T2_10_Single, nmse_results_T2_10_Single,\
            psnr_results_T2_10_Single_std, ssim_results_T2_10_Single_std, nmse_results_T2_10_Single_std= CalValue(
        ...
        psnr_results_T2_04_Multi, ssim_results_T2_04_Multi, nmse_results_T2_04_Multi,\
            psnr_results_T2_04_Multi_std, ssim_results_T2_04_Multi_std, nmse_results_T2_04_Multi_std= CalValue(
        ...
        psnr_results_T2_08_Multi, ssim_results_T2_08_Multi, nmse_results_T2_08_Multi,\
            psnr_results_T2_08_Multi_std, ssim_results_T2_08_Multi_std, nmse_results_T2_08_Multi_std= CalValue(
        ...
        psnr_results_T2_10_Multi, ssim_results_T2_10_Multi, nmse_results_T2_10_Multi,\
            psnr_results_T2_10_Multi_std, ssim_results_T2_10_Multi_std, nmse_results_T2_10_Multi_std= CalValue(
    ...
    if args.task =='Cine':
        ...
        scores = {
            ...
            ##
            "Single_Lax_04_PSNR_std": (np.std(psnr_results_lax_04_Single)),
            "Single_Lax_08_PSNR_std": (np.std(psnr_results_lax_08_Single)),
            "Single_Lax_10_PSNR_std": (np.std(psnr_results_lax_10_Single)),
            "Single_Lax_04_SSIM_std": (np.std(ssim_results_lax_04_Single)),
            "Single_Lax_08_SSIM_std": (np.std(ssim_results_lax_08_Single)),
            "Single_Lax_10_SSIM_std": (np.std(ssim_results_lax_10_Single)),
            "Single_Lax_04_NMSE_std": (np.std(nmse_results_lax_04_Single)),
            "Single_Lax_08_NMSE_std": (np.std(nmse_results_lax_08_Single)),
            "Single_Lax_10_NMSE_std": (np.std(nmse_results_lax_10_Single)),
            "Multi_Lax_04_PSNR_std": (np.std(psnr_results_lax_04_Multi)),
            "Multi_Lax_08_PSNR_std": (np.std(psnr_results_lax_08_Multi)),
            "Multi_Lax_10_PSNR_std": (np.std(psnr_results_lax_10_Multi)),
            "Multi_Lax_04_SSIM_std": (np.std(ssim_results_lax_04_Multi)),
            "Multi_Lax_08_SSIM_std": (np.std(ssim_results_lax_08_Multi)),
            "Multi_Lax_10_SSIM_std": (np.std(ssim_results_lax_10_Multi)),
            "Multi_Lax_04_NMSE_std": (np.std(nmse_results_lax_04_Multi)),
            "Multi_Lax_08_NMSE_std": (np.std(nmse_results_lax_08_Multi)),
            "Multi_Lax_10_NMSE_std": (np.std(nmse_results_lax_10_Multi)),
            "Single_Sax_04_PSNR_std": (np.std(psnr_results_sax_04_Single)),
            "Single_Sax_08_PSNR_std": (np.std(psnr_results_sax_08_Single)),
            "Single_Sax_10_PSNR_std": (np.std(psnr_results_sax_10_Single)),
            "Single_Sax_04_SSIM_std": (np.std(ssim_results_sax_04_Single)),
            "Single_Sax_08_SSIM_std": (np.std(ssim_results_sax_08_Single)),
            "Single_Sax_10_SSIM_std": (np.std(ssim_results_sax_10_Single)),
            "Single_Sax_04_NMSE_std": (np.std(nmse_results_sax_04_Single)),
            "Single_Sax_08_NMSE_std": (np.std(nmse_results_sax_08_Single)),
            "Single_Sax_10_NMSE_std": (np.std(nmse_results_sax_10_Single)),
            "Multi_Sax_04_PSNR_std": (np.std(psnr_results_sax_04_Multi)),
            "Multi_Sax_08_PSNR_std": (np.std(psnr_results_sax_08_Multi)),
            "Multi_Sax_10_PSNR_std": (np.std(psnr_results_sax_10_Multi)),
            "Multi_Sax_04_SSIM_std": (np.std(ssim_results_sax_04_Multi)),
            "Multi_Sax_08_SSIM_std": (np.std(ssim_results_sax_08_Multi)),
            "Multi_Sax_10_SSIM_std": (np.std(ssim_results_sax_10_Multi)),
            "Multi_Sax_04_NMSE_std": (np.std(nmse_results_sax_04_Multi)),
            "Multi_Sax_08_NMSE_std": (np.std(nmse_results_sax_08_Multi)),
            "Multi_Sax_10_NMSE_std": (np.std(nmse_results_sax_10_Multi)),
            ##
        ...
        scores = {
            ...
            "num_file_T2_04_Single": str(num_task_T2_04_Single)+ "/107", # + str(num_gt_T2_04_Single),
            "num_file_T2_08_Single": str(num_task_T2_08_Single)+ "/107", # + str(num_gt_T2_08_Single),
            "num_file_T2_10_Single": str(num_task_T2_10_Single)+ "/107", # + str(num_gt_T2_10_Single),
            "num_file_T1_04_Multi": str(num_task_T1_04_Multi)+ "/108", # + str(num_gt_T1_04_Multi),
            "num_file_T1_08_Multi": str(num_task_T1_08_Multi)+ "/108", # + str(num_gt_T1_04_Multi),
            "num_file_T1_10_Multi": str(num_task_T1_10_Multi)+ "/108", # + str(num_gt_T1_04_Multi),
            "num_file_T2_04_Multi": str(num_task_T2_04_Multi)+ "/107", # + str(num_gt_T2_04_Multi),
            "num_file_T2_08_Multi": str(num_task_T2_08_Multi)+ "/107", # + str(num_gt_T2_08_Multi),
            "num_file_T2_10_Multi": str(num_task_T2_10_Multi)+ "/107", # + str(num_gt_T2_10_Multi),
            ...
            ##
            "Single_T1_04_PSNR_std": (np.std(psnr_results_T1_04_Single)),
            "Single_T1_08_PSNR_std": (np.std(psnr_results_T1_08_Single)),
            "Single_T1_10_PSNR_std": (np.std(psnr_results_T1_10_Single)),
            "Single_T1_04_SSIM_std": (np.std(ssim_results_T1_04_Single)),
            "Single_T1_08_SSIM_std": (np.std(ssim_results_T1_08_Single)),
            "Single_T1_10_SSIM_std": (np.std(ssim_results_T1_10_Single)),
            "Single_T1_04_NMSE_std": (np.std(nmse_results_T1_04_Single)),
            "Single_T1_08_NMSE_std": (np.std(nmse_results_T1_08_Single)),
            "Single_T1_10_NMSE_std": (np.std(nmse_results_T1_10_Single)),
            "Multi_T1_04_PSNR_std": (np.std(psnr_results_T1_04_Multi)),
            "Multi_T1_08_PSNR_std": (np.std(psnr_results_T1_08_Multi)),
            "Multi_T1_10_PSNR_std": (np.std(psnr_results_T1_10_Multi)),
            "Multi_T1_04_SSIM_std": (np.std(ssim_results_T1_04_Multi)),
            "Multi_T1_08_SSIM_std": (np.std(ssim_results_T1_08_Multi)),
            "Multi_T1_10_SSIM_std": (np.std(ssim_results_T1_10_Multi)),
            "Multi_T1_04_NMSE_std": (np.std(nmse_results_T1_04_Multi)),
            "Multi_T1_08_NMSE_std": (np.std(nmse_results_T1_08_Multi)),
            "Multi_T1_10_NMSE_std": (np.std(nmse_results_T1_10_Multi)),
            "Single_T2_04_PSNR_std": (np.std(psnr_results_T2_04_Single)),
            "Single_T2_08_PSNR_std": (np.std(psnr_results_T2_08_Single)),
            "Single_T2_10_PSNR_std": (np.std(psnr_results_T2_10_Single)),
            "Single_T2_04_SSIM_std": (np.std(ssim_results_T2_04_Single)),
            "Single_T2_08_SSIM_std": (np.std(ssim_results_T2_08_Single)),
            "Single_T2_10_SSIM_std": (np.std(ssim_results_T2_10_Single)),
            "Single_T2_04_NMSE_std": (np.std(nmse_results_T2_04_Single)),
            "Single_T2_08_NMSE_std": (np.std(nmse_results_T2_08_Single)),
            "Single_T2_10_NMSE_std": (np.std(nmse_results_T2_10_Single)),
            "Multi_T2_04_PSNR_std": (np.std(psnr_results_T2_04_Multi)),
            "Multi_T2_08_PSNR_std": (np.std(psnr_results_T2_08_Multi)),
            "Multi_T2_10_PSNR_std": (np.std(psnr_results_T2_10_Multi)),
            "Multi_T2_04_SSIM_std": (np.std(ssim_results_T2_04_Multi)),
            "Multi_T2_08_SSIM_std": (np.std(ssim_results_T2_08_Multi)),
            "Multi_T2_10_SSIM_std": (np.std(ssim_results_T2_10_Multi)),
            "Multi_T2_04_NMSE_std": (np.std(nmse_results_T2_04_Multi)),
            "Multi_T2_08_NMSE_std": (np.std(nmse_results_T2_08_Multi)),
            "Multi_T2_10_NMSE_std": (np.std(nmse_results_T2_10_Multi)),
            ##
