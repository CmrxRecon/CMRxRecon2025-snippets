...
def check_mapping_data(gt_dir, target_dir, R, Sub_Task):
    ...
    flag_file, different_sizes, missing_files, openfail_files, complete_folders, task_num_file, gt_num_file = check_mat_files(
        gt_dir, target_dir,
...
def CalValue(complete_folders, gt_dir, target_dir, Sub_Task):
    ...
    for folder in complete_folders:
        ...
        PSNR_list_std.append(np.std(psnr_array))
        SSIM_list_std.append(np.std(ssim_array))
        NMSE_list_std.append(np.std(nmse_array))

    psnr_results = np.mean(PSNR_list)
    ssim_results = np.mean(SSIM_list)
    nmse_results = np.mean(NMSE_list)
    psnr_results_std = np.mean(PSNR_list_std)
    ssim_results_std = np.mean(SSIM_list_std)
    nmse_results_std = np.mean(NMSE_list_std)
    return psnr_results, ssim_results, nmse_results,psnr_results_std,ssim_results_std,nmse_results_std,PSNR_list,SSIM_list,NMSE_list
...
def main():
    ...
    if os.path.isfile(submission_file):
        ...
        assert 0 == os.system(
            f'mkdir tmp-dir && cp {submission_file} {new_path}'), 'Failed to make directory or copy file'
        unzipfile(new_path)
    ...
    if args.task == 'Cine':
        ...
        psnr_results_lax_04_Single, ssim_results_lax_04_Single, nmse_results_lax_04_Single,\
            psnr_results_lax_04_Single_std, ssim_results_lax_04_Single_std, nmse_results_lax_04_Single_std,PSNR_list_lax_04_Single,SSIM_list_lax_04_Single,NMSE_list_lax_04_Single = CalValue(
            complete_folders_lax_04_Single, gt_dir04, target_dir04, Sub_Task)
        psnr_results_lax_08_Single, ssim_results_lax_08_Single, nmse_results_lax_08_Single,\
            psnr_results_lax_08_Single_std, ssim_results_lax_08_Single_std, nmse_results_lax_08_Single_std,PSNR_list_lax_08_Single,SSIM_list_lax_08_Single,NMSE_list_lax_08_Single= CalValue(
            complete_folders_lax_08_Single, gt_dir08, target_dir08, Sub_Task)
        psnr_results_lax_10_Single, ssim_results_lax_10_Single, nmse_results_lax_10_Single,\
            psnr_results_lax_10_Single_std, ssim_results_lax_10_Single_std, nmse_results_lax_10_Single_std,PSNR_list_lax_10_Single,SSIM_list_lax_10_Single,NMSE_list_lax_10_Single= CalValue(
        ...
        psnr_results_lax_04_Multi, ssim_results_lax_04_Multi, nmse_results_lax_04_Multi,\
            psnr_results_lax_04_Multi_std, ssim_results_lax_04_Multi_std, nmse_results_lax_04_Multi_std,PSNR_list_lax_04_Multi,SSIM_list_lax_04_Multi,NMSE_list_lax_04_Multi= CalValue(
            complete_folders_lax_04_Multi, gt_dir04, target_dir04, Sub_Task)

        psnr_results_lax_08_Multi, ssim_results_lax_08_Multi, nmse_results_lax_08_Multi,\
            psnr_results_lax_08_Multi_std, ssim_results_lax_08_Multi_std, nmse_results_lax_08_Multi_std,PSNR_list_lax_08_Multi,SSIM_list_lax_08_Multi,NMSE_list_lax_08_Multi= CalValue(
            complete_folders_lax_08_Multi, gt_dir08, target_dir08, Sub_Task)

        psnr_results_lax_10_Multi, ssim_results_lax_10_Multi, nmse_results_lax_10_Multi,\
            psnr_results_lax_10_Multi_std, ssim_results_lax_10_Multi_std, nmse_results_lax_10_Multi_std,PSNR_list_lax_10_Multi,SSIM_list_lax_10_Multi,NMSE_list_lax_10_Multi = CalValue(
        ...
        psnr_results_sax_04_Single, ssim_results_sax_04_Single, nmse_results_sax_04_Single,\
            psnr_results_sax_04_Single_std, ssim_results_sax_04_Single_std, nmse_results_sax_04_Single_std,PSNR_list_sax_04_Single,SSIM_list_sax_04_Single,NMSE_list_sax_04_Single= CalValue(
            complete_folders_sax_04_Single, gt_dir04, target_dir04, Sub_Task)
        psnr_results_sax_08_Single, ssim_results_sax_08_Single, nmse_results_sax_08_Single,\
            psnr_results_sax_08_Single_std, ssim_results_sax_08_Single_std, nmse_results_sax_08_Single_std,PSNR_list_sax_08_Single,SSIM_list_sax_08_Single,NMSE_list_sax_08_Single= CalValue(
            complete_folders_sax_08_Single, gt_dir08, target_dir08, Sub_Task)
        psnr_results_sax_10_Single, ssim_results_sax_10_Single, nmse_results_sax_10_Single,\
            psnr_results_sax_10_Single_std, ssim_results_sax_10_Single_std, nmse_results_sax_10_Single_std,PSNR_list_sax_10_Single,SSIM_list_sax_10_Single,NMSE_list_sax_10_Single= CalValue(
        ...
        psnr_results_sax_04_Multi, ssim_results_sax_04_Multi, nmse_results_sax_04_Multi,\
            psnr_results_sax_04_Multi_std, ssim_results_sax_04_Multi_std, nmse_results_sax_04_Multi_std,PSNR_list_sax_04_Multi,SSIM_list_sax_04_Multi,NMSE_list_sax_04_Multi= CalValue(
            complete_folders_sax_04_Multi, gt_dir04, target_dir04, Sub_Task)

        psnr_results_sax_08_Multi, ssim_results_sax_08_Multi, nmse_results_sax_08_Multi,\
            psnr_results_sax_08_Multi_std, ssim_results_sax_08_Multi_std, nmse_results_sax_08_Multi_std,PSNR_list_sax_08_Multi,SSIM_list_sax_08_Multi,NMSE_list_sax_08_Multi= CalValue(
            complete_folders_sax_08_Multi, gt_dir08, target_dir08, Sub_Task)

        psnr_results_sax_10_Multi, ssim_results_sax_10_Multi, nmse_results_sax_10_Multi,\
            psnr_results_sax_10_Multi_std, ssim_results_sax_10_Multi_std, nmse_results_sax_10_Multi_std,PSNR_list_sax_10_Multi,SSIM_list_sax_10_Multi,NMSE_list_sax_10_Multi= CalValue(
        ...
        psnr_results_T1_04_Single, ssim_results_T1_04_Single, nmse_results_T1_04_Single,\
            psnr_results_T1_04_Single_std, ssim_results_T1_04_Single_std, nmse_results_T1_04_Single_std,PSNR_list_T1_04_Single,SSIM_list_T1_04_Single,NMSE_list_T1_04_Single= CalValue(
            complete_folders_T1_04_Single, gt_dir04, target_dir04, Sub_Task)
        psnr_results_T1_08_Single, ssim_results_T1_08_Single, nmse_results_T1_08_Single,\
            psnr_results_T1_08_Single_std, ssim_results_T1_08_Single_std, nmse_results_T1_08_Single_std,PSNR_list_T1_08_Single,SSIM_list_T1_08_Single,NMSE_list_T1_08_Single= CalValue(
            complete_folders_T1_08_Single, gt_dir08, target_dir08, Sub_Task)
        psnr_results_T1_10_Single, ssim_results_T1_10_Single, nmse_results_T1_10_Single,\
            psnr_results_T1_10_Single_std, ssim_results_T1_10_Single_std, nmse_results_T1_10_Single_std,PSNR_list_T1_10_Single,SSIM_list_T1_10_Single,NMSE_list_T1_10_Single= CalValue(
        ...
        psnr_results_T1_04_Multi, ssim_results_T1_04_Multi, nmse_results_T1_04_Multi,\
            psnr_results_T1_04_Multi_std, ssim_results_T1_04_Multi_std, nmse_results_T1_04_Multi_std,PSNR_list_T1_04_Multi,SSIM_list_T1_04_Multi,NMSE_list_T1_04_Multi= CalValue(
            complete_folders_T1_04_Multi, gt_dir04, target_dir04, Sub_Task)

        psnr_results_T1_08_Multi, ssim_results_T1_08_Multi, nmse_results_T1_08_Multi,\
            psnr_results_T1_08_Multi_std, ssim_results_T1_08_Multi_std, nmse_results_T1_08_Multi_std,PSNR_list_T1_08_Multi,SSIM_list_T1_08_Multi,NMSE_list_T1_08_Multi= CalValue(
            complete_folders_T1_08_Multi, gt_dir08, target_dir08, Sub_Task)

        psnr_results_T1_10_Multi, ssim_results_T1_10_Multi, nmse_results_T1_10_Multi,\
            psnr_results_T1_10_Multi_std, ssim_results_T1_10_Multi_std, nmse_results_T1_10_Multi_std,PSNR_list_T1_10_Multi,SSIM_list_T1_10_Multi,NMSE_list_T1_10_Multi= CalValue(
        ...
        psnr_results_T2_04_Single, ssim_results_T2_04_Single, nmse_results_T2_04_Single,\
            psnr_results_T2_04_Single_std, ssim_results_T2_04_Single_std, nmse_results_T2_04_Single_std,PSNR_list_T2_04_Single,SSIM_list_T2_04_Single,NMSE_list_T2_04_Single= CalValue(
            complete_folders_T2_04_Single, gt_dir04, target_dir04, Sub_Task)
        psnr_results_T2_08_Single, ssim_results_T2_08_Single, nmse_results_T2_08_Single,\
            psnr_results_T2_08_Single_std, ssim_results_T2_08_Single_std, nmse_results_T2_08_Single_std,PSNR_list_T2_08_Single,SSIM_list_T2_08_Single,NMSE_list_T2_08_Single= CalValue(
            complete_folders_T2_08_Single, gt_dir08, target_dir08, Sub_Task)
        psnr_results_T2_10_Single, ssim_results_T2_10_Single, nmse_results_T2_10_Single,\
            psnr_results_T2_10_Single_std, ssim_results_T2_10_Single_std, nmse_results_T2_10_Single_std,PSNR_list_T2_10_Single,SSIM_list_T2_10_Single,NMSE_list_T2_10_Single= CalValue(
        ...
        psnr_results_T2_04_Multi, ssim_results_T2_04_Multi, nmse_results_T2_04_Multi,\
            psnr_results_T2_04_Multi_std, ssim_results_T2_04_Multi_std, nmse_results_T2_04_Multi_std,PSNR_list_T2_04_Multi,SSIM_list_T2_04_Multi,NMSE_list_T2_04_Multi= CalValue(
            complete_folders_T2_04_Multi, gt_dir04, target_dir04, Sub_Task)

        psnr_results_T2_08_Multi, ssim_results_T2_08_Multi, nmse_results_T2_08_Multi,\
            psnr_results_T2_08_Multi_std, ssim_results_T2_08_Multi_std, nmse_results_T2_08_Multi_std,PSNR_list_T2_08_Multi,SSIM_list_T2_08_Multi,NMSE_list_T2_08_Multi= CalValue(
            complete_folders_T2_08_Multi, gt_dir08, target_dir08, Sub_Task)

        psnr_results_T2_10_Multi, ssim_results_T2_10_Multi, nmse_results_T2_10_Multi,\
            psnr_results_T2_10_Multi_std, ssim_results_T2_10_Multi_std, nmse_results_T2_10_Multi_std,PSNR_list_T2_10_Multi,SSIM_list_T2_10_Multi,NMSE_list_T2_10_Multi= CalValue(
    ...
    if args.task == 'Cine':
        ...
        scores = {
            ...
            ##
            "Single_Lax_04_PSNR_std": (np.round(psnr_results_lax_04_Single_std, 4)),
            "Single_Lax_08_PSNR_std": (np.round(psnr_results_lax_08_Single_std, 4)),
            "Single_Lax_10_PSNR_std": (np.round(psnr_results_lax_10_Single_std, 4)),
            "Single_Lax_04_SSIM_std": (np.round(ssim_results_lax_04_Single_std, 4)),
            "Single_Lax_08_SSIM_std": (np.round(ssim_results_lax_08_Single_std, 4)),
            "Single_Lax_10_SSIM_std": (np.round(ssim_results_lax_10_Single_std, 4)),
            "Single_Lax_04_NMSE_std": (np.round(nmse_results_lax_04_Single_std, 4)),
            "Single_Lax_08_NMSE_std": (np.round(nmse_results_lax_08_Single_std, 4)),
            "Single_Lax_10_NMSE_std": (np.round(nmse_results_lax_10_Single_std, 4)),
            "Multi_Lax_04_PSNR_std": (np.round(psnr_results_lax_04_Multi_std, 4)),
            "Multi_Lax_08_PSNR_std": (np.round(psnr_results_lax_08_Multi_std, 4)),
            "Multi_Lax_10_PSNR_std": (np.round(psnr_results_lax_10_Multi_std, 4)),
            "Multi_Lax_04_SSIM_std": (np.round(ssim_results_lax_04_Multi_std, 4)),
            "Multi_Lax_08_SSIM_std": (np.round(ssim_results_lax_08_Multi_std, 4)),
            "Multi_Lax_10_SSIM_std": (np.round(ssim_results_lax_10_Multi_std, 4)),
            "Multi_Lax_04_NMSE_std": (np.round(nmse_results_lax_04_Multi_std, 4)),
            "Multi_Lax_08_NMSE_std": (np.round(nmse_results_lax_08_Multi_std, 4)),
            "Multi_Lax_10_NMSE_std": (np.round(nmse_results_lax_10_Multi_std, 4)),
            "Single_Sax_04_PSNR_std": (np.round(psnr_results_sax_04_Single_std, 4)),
            "Single_Sax_08_PSNR_std": (np.round(psnr_results_sax_08_Single_std, 4)),
            "Single_Sax_10_PSNR_std": (np.round(psnr_results_sax_10_Single_std, 4)),
            "Single_Sax_04_SSIM_std": (np.round(ssim_results_sax_04_Single_std, 4)),
            "Single_Sax_08_SSIM_std": (np.round(ssim_results_sax_08_Single_std, 4)),
            "Single_Sax_10_SSIM_std": (np.round(ssim_results_sax_10_Single_std, 4)),
            "Single_Sax_04_NMSE_std": (np.round(nmse_results_sax_04_Single_std, 4)),
            "Single_Sax_08_NMSE_std": (np.round(nmse_results_sax_08_Single_std, 4)),
            "Single_Sax_10_NMSE_std": (np.round(nmse_results_sax_10_Single_std, 4)),
            "Multi_Sax_04_PSNR_std": (np.round(psnr_results_sax_04_Multi_std, 4)),
            "Multi_Sax_08_PSNR_std": (np.round(psnr_results_sax_08_Multi_std, 4)),
            "Multi_Sax_10_PSNR_std": (np.round(psnr_results_sax_10_Multi_std, 4)),
            "Multi_Sax_04_SSIM_std": (np.round(ssim_results_sax_04_Multi_std, 4)),
            "Multi_Sax_08_SSIM_std": (np.round(ssim_results_sax_08_Multi_std, 4)),
            "Multi_Sax_10_SSIM_std": (np.round(ssim_results_sax_10_Multi_std, 4)),
            "Multi_Sax_04_NMSE_std": (np.round(nmse_results_sax_04_Multi_std, 4)),
            "Multi_Sax_08_NMSE_std": (np.round(nmse_results_sax_08_Multi_std, 4)),
            "Multi_Sax_10_NMSE_std": (np.round(nmse_results_sax_10_Multi_std, 4)),
            ##
            "PSNR_list_sax_04_Single": np.asarray(PSNR_list_sax_04_Single),
            "SSIM_list_sax_04_Single": np.asarray(SSIM_list_sax_04_Single),
            "NMSE_list_sax_04_Single": np.asarray(NMSE_list_sax_04_Single),
            "PSNR_list_sax_08_Single": np.asarray(PSNR_list_sax_08_Single),
            "SSIM_list_sax_08_Single": np.asarray(SSIM_list_sax_08_Single),
            "NMSE_list_sax_08_Single": np.asarray(NMSE_list_sax_08_Single),
            "PSNR_list_sax_10_Single": np.asarray(PSNR_list_sax_10_Single),
            "SSIM_list_sax_10_Single": np.asarray(SSIM_list_sax_10_Single),
            "NMSE_list_sax_10_Single": np.asarray(NMSE_list_sax_10_Single),
            "PSNR_list_sax_04_Multi": np.asarray(PSNR_list_sax_04_Multi),
            "SSIM_list_sax_04_Multi": np.asarray(SSIM_list_sax_04_Multi),
            "NMSE_list_sax_04_Multi": np.asarray(NMSE_list_sax_04_Multi),
            "PSNR_list_sax_08_Multi": np.asarray(PSNR_list_sax_08_Multi),
            "SSIM_list_sax_08_Multi": np.asarray(SSIM_list_sax_08_Multi),
            "NMSE_list_sax_08_Multi": np.asarray(NMSE_list_sax_08_Multi),
            "PSNR_list_sax_10_Multi": np.asarray(PSNR_list_sax_10_Multi),
            "SSIM_list_sax_10_Multi": np.asarray(SSIM_list_sax_10_Multi),
            "NMSE_list_sax_10_Multi": np.asarray(NMSE_list_sax_10_Multi),
            "PSNR_list_lax_04_Single": np.asarray(PSNR_list_lax_04_Single),
            "SSIM_list_lax_04_Single": np.asarray(SSIM_list_lax_04_Single),
            "NMSE_list_lax_04_Single": np.asarray(NMSE_list_lax_04_Single),
            "PSNR_list_lax_08_Single": np.asarray(PSNR_list_lax_08_Single),
            "SSIM_list_lax_08_Single": np.asarray(SSIM_list_lax_08_Single),
            "NMSE_list_lax_08_Single": np.asarray(NMSE_list_lax_08_Single),
            "PSNR_list_lax_10_Single": np.asarray(PSNR_list_lax_10_Single),
            "SSIM_list_lax_10_Single": np.asarray(SSIM_list_lax_10_Single),
            "NMSE_list_lax_10_Single": np.asarray(NMSE_list_lax_10_Single),
            "PSNR_list_lax_04_Multi": np.asarray(PSNR_list_lax_04_Multi),
            "SSIM_list_lax_04_Multi": np.asarray(SSIM_list_lax_04_Multi),
            "NMSE_list_lax_04_Multi": np.asarray(NMSE_list_lax_04_Multi),
            "PSNR_list_lax_08_Multi": np.asarray(PSNR_list_lax_08_Multi),
            "SSIM_list_lax_08_Multi": np.asarray(SSIM_list_lax_08_Multi),
            "NMSE_list_lax_08_Multi": np.asarray(NMSE_list_lax_08_Multi),
            "PSNR_list_lax_10_Multi": np.asarray(PSNR_list_lax_10_Multi),
            "SSIM_list_lax_10_Multi": np.asarray(SSIM_list_lax_10_Multi),
            "NMSE_list_lax_10_Multi": np.asarray(NMSE_list_lax_10_Multi),
            ##
        ...
        scores = {
            ...
            ##
            "Single_T1_04_PSNR_std": (np.round(psnr_results_T1_04_Single_std, 4)),
            "Single_T1_08_PSNR_std": (np.round(psnr_results_T1_08_Single_std, 4)),
            "Single_T1_10_PSNR_std": (np.round(psnr_results_T1_10_Single_std, 4)),
            "Single_T1_04_SSIM_std": (np.round(ssim_results_T1_04_Single_std, 4)),
            "Single_T1_08_SSIM_std": (np.round(ssim_results_T1_08_Single_std, 4)),
            "Single_T1_10_SSIM_std": (np.round(ssim_results_T1_10_Single_std, 4)),
            "Single_T1_04_NMSE_std": (np.round(nmse_results_T1_04_Single_std, 4)),
            "Single_T1_08_NMSE_std": (np.round(nmse_results_T1_08_Single_std, 4)),
            "Single_T1_10_NMSE_std": (np.round(nmse_results_T1_10_Single_std, 4)),
            "Multi_T1_04_PSNR_std": (np.round(psnr_results_T1_04_Multi_std, 4)),
            "Multi_T1_08_PSNR_std": (np.round(psnr_results_T1_08_Multi_std, 4)),
            "Multi_T1_10_PSNR_std": (np.round(psnr_results_T1_10_Multi_std, 4)),
            "Multi_T1_04_SSIM_std": (np.round(ssim_results_T1_04_Multi_std, 4)),
            "Multi_T1_08_SSIM_std": (np.round(ssim_results_T1_08_Multi_std, 4)),
            "Multi_T1_10_SSIM_std": (np.round(ssim_results_T1_10_Multi_std, 4)),
            "Multi_T1_04_NMSE_std": (np.round(nmse_results_T1_04_Multi_std, 4)),
            "Multi_T1_08_NMSE_std": (np.round(nmse_results_T1_08_Multi_std, 4)),
            "Multi_T1_10_NMSE_std": (np.round(nmse_results_T1_10_Multi_std, 4)),
            "Single_T2_04_PSNR_std": (np.round(psnr_results_T2_04_Single_std, 4)),
            "Single_T2_08_PSNR_std": (np.round(psnr_results_T2_08_Single_std, 4)),
            "Single_T2_10_PSNR_std": (np.round(psnr_results_T2_10_Single_std, 4)),
            "Single_T2_04_SSIM_std": (np.round(ssim_results_T2_04_Single_std, 4)),
            "Single_T2_08_SSIM_std": (np.round(ssim_results_T2_08_Single_std, 4)),
            "Single_T2_10_SSIM_std": (np.round(ssim_results_T2_10_Single_std, 4)),
            "Single_T2_04_NMSE_std": (np.round(nmse_results_T2_04_Single_std, 4)),
            "Single_T2_08_NMSE_std": (np.round(nmse_results_T2_08_Single_std, 4)),
            "Single_T2_10_NMSE_std": (np.round(nmse_results_T2_10_Single_std, 4)),
            "Multi_T2_04_PSNR_std": (np.round(psnr_results_T2_04_Multi_std, 4)),
            "Multi_T2_08_PSNR_std": (np.round(psnr_results_T2_08_Multi_std, 4)),
            "Multi_T2_10_PSNR_std": (np.round(psnr_results_T2_10_Multi_std, 4)),
            "Multi_T2_04_SSIM_std": (np.round(ssim_results_T2_04_Multi_std, 4)),
            "Multi_T2_08_SSIM_std": (np.round(ssim_results_T2_08_Multi_std, 4)),
            "Multi_T2_10_SSIM_std": (np.round(ssim_results_T2_10_Multi_std, 4)),
            "Multi_T2_04_NMSE_std": (np.round(nmse_results_T2_04_Multi_std, 4)),
            "Multi_T2_08_NMSE_std": (np.round(nmse_results_T2_08_Multi_std, 4)),
            "Multi_T2_10_NMSE_std": (np.round(nmse_results_T2_10_Multi_std, 4)),
            ##
            "PSNR_list_T1_04_Single": np.asarray(PSNR_list_T1_04_Single),
            "SSIM_list_T1_04_Single": np.asarray(SSIM_list_T1_04_Single),
            "NMSE_list_T1_04_Single": np.asarray(NMSE_list_T1_04_Single),
            "PSNR_list_T1_08_Single": np.asarray(PSNR_list_T1_08_Single),
            "SSIM_list_T1_08_Single": np.asarray(SSIM_list_T1_08_Single),
            "NMSE_list_T1_08_Single": np.asarray(NMSE_list_T1_08_Single),
            "PSNR_list_T1_10_Single": np.asarray(PSNR_list_T1_10_Single),
            "SSIM_list_T1_10_Single": np.asarray(SSIM_list_T1_10_Single),
            "NMSE_list_T1_10_Single": np.asarray(NMSE_list_T1_10_Single),
            "PSNR_list_T1_04_Multi": np.asarray(PSNR_list_T1_04_Multi),
            "SSIM_list_T1_04_Multi": np.asarray(SSIM_list_T1_04_Multi),
            "NMSE_list_T1_04_Multi": np.asarray(NMSE_list_T1_04_Multi),
            "PSNR_list_T1_08_Multi": np.asarray(PSNR_list_T1_08_Multi),
            "SSIM_list_T1_08_Multi": np.asarray(SSIM_list_T1_08_Multi),
            "NMSE_list_T1_08_Multi": np.asarray(NMSE_list_T1_08_Multi),
            "PSNR_list_T1_10_Multi": np.asarray(PSNR_list_T1_10_Multi),
            "SSIM_list_T1_10_Multi": np.asarray(SSIM_list_T1_10_Multi),
            "NMSE_list_T1_10_Multi": np.asarray(NMSE_list_T1_10_Multi),
            "PSNR_list_T2_04_Single": np.asarray(PSNR_list_T2_04_Single),
            "SSIM_list_T2_04_Single": np.asarray(SSIM_list_T2_04_Single),
            "NMSE_list_T2_04_Single": np.asarray(NMSE_list_T2_04_Single),
            "PSNR_list_T2_08_Single": np.asarray(PSNR_list_T2_08_Single),
            "SSIM_list_T2_08_Single": np.asarray(SSIM_list_T2_08_Single),
            "NMSE_list_T2_08_Single": np.asarray(NMSE_list_T2_08_Single),
            "PSNR_list_T2_10_Single": np.asarray(PSNR_list_T2_10_Single),
            "SSIM_list_T2_10_Single": np.asarray(SSIM_list_T2_10_Single),
            "NMSE_list_T2_10_Single": np.asarray(NMSE_list_T2_10_Single),
            "PSNR_list_T2_04_Multi": np.asarray(PSNR_list_T2_04_Multi),
            "SSIM_list_T2_04_Multi": np.asarray(SSIM_list_T2_04_Multi),
            "NMSE_list_T2_04_Multi": np.asarray(NMSE_list_T2_04_Multi),
            "PSNR_list_T2_08_Multi": np.asarray(PSNR_list_T2_08_Multi),
            "SSIM_list_T2_08_Multi": np.asarray(SSIM_list_T2_08_Multi),
            "NMSE_list_T2_08_Multi": np.asarray(NMSE_list_T2_08_Multi),
            "PSNR_list_T2_10_Multi": np.asarray(PSNR_list_T2_10_Multi),
            "SSIM_list_T2_10_Multi": np.asarray(SSIM_list_T2_10_Multi),
            "NMSE_list_T2_10_Multi": np.asarray(NMSE_list_T2_10_Multi),
            ##
            "Mapping_PSNR": np.round(psnr_mean, 4),
            "Mapping_SSIM": np.round(ssim_mean, 4),
            "Mapping_NMSE": np.round(nmse_mean, 4)
        }
    with open(args.results, "wb") as out:
    ...
    assert 0 == os.system('zip better_log.zip *.json *.pkl')
    print('All checked!')
